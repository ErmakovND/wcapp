...
class WeatherWebXmlLoaderImplTest {
    ...
    void testLoad() throws XmlException {
        ...
        Mockito.when(webLoadClient.get(ArgumentMatchers.eq("/history.xml"), ArgumentMatchers.any(MultiValueMap.class)))
        ...
        Mockito.verify(webLoadClient, Mockito.times(1))
                .get(ArgumentMatchers.eq("/history.xml"), ArgumentMatchers.any(MultiValueMap.class));
